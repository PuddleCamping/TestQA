...
Функционал: Создание документа посутпления товаров	
...
Сценарий: Я создаю документ поступления
// создание документа
*Открытие формы создание шагов
...
*Проверка создания табличной части
...
Сценарий: Я проверяю наличие в справочнике Номенклатура Торт
